                    ...
                    <div class="p-6 sm:p-8 lg:p-10">
                        <form @submit.prevent="submit" class="space-y-6">
                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                ...
                                <div class="space-y-2 animate-fade-in">
                                    <label class="flex items-center gap-2 text-sm font-semibold text-gray-700">
                                        ...
                                        Designación
                                        <span
                                            class="px-2 py-0.5 bg-red-100 text-red-600 text-xs font-bold rounded">Requerido</span>
                                    </label>
                                    ...
                                    <transition enter-active-class="transition ease-out duration-200"
                                        ...
                                        <div v-if="form.errors.designation"
                                            ...
                                            <span class="text-red-700 text-sm font-medium">{{ form.errors.designation
                                            }}</span>
                                        </div>
                                    </transition>
                                </div>
                                ...
                                <div class="space-y-2 animate-fade-in" style="animation-delay: 0.1s;">
                                    <label class="flex items-center gap-2 text-sm font-semibold text-gray-700">
                                        ...
                                        Dirección
                                        <span
                                            class="px-2 py-0.5 bg-gray-100 text-gray-600 text-xs font-medium rounded">Opcional</span>
                                    </label>
                                    <div class="relative group">
                                        <div
                                ...
                                <div class="space-y-2 animate-fade-in" style="animation-delay: 0.2s;">
                                    ...
                                    <div class="relative group">
                                        <div
                                            class="absolute -inset-0.5 bg-gradient-to-r from-purple-600 to-pink-600 rounded-xl opacity-0 group-hover:opacity-10 transition duration-300 blur">
                                        </div>
                                        <div class="relative">
                                            <div
                                                class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                                <svg class="w-5 h-5 text-gray-400 group-hover:text-purple-500 transition-colors"
                                                    xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                    stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                                        stroke-width="2"
                                            ...
                                            <input v-model.number="form.max_capacity_kg" type="number" min="0" step="1"
                                                class="w-full pl-12 pr-16 py-3.5 text-sm bg-gray-50 border-2 border-gray-200 focus:bg-white focus:border-purple-500 focus:ring-4 focus:ring-purple-100 rounded-xl transition-all duration-300"
                                                placeholder="Ej: 450" />
                                            <div class="absolute inset-y-0 right-0 pr-4 flex items-center gap-2">
                                                <span v-if="form.max_capacity_kg"
                                                    class="text-xs font-medium text-gray-500">kg</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="space-y-2 animate-fade-in" style="animation-delay: 0.3s;">
                                ...
                                <div class="relative group">
                                    <div
                                        class="absolute -inset-0.5 bg-gradient-to-r from-indigo-600 to-blue-600 rounded-xl opacity-0 group-hover:opacity-10 transition duration-300 blur">
                                    </div>
                                    <div class="relative">
                                        <textarea v-model="form.comments" rows="3"
                                            class="w-full px-4 py-3.5 text-sm bg-gray-50 border-2 border-gray-200 focus:bg-white focus:border-indigo-500 focus:ring-4 focus:ring-indigo-100 rounded-xl transition-all duration-300 resize-none"
                                            placeholder="Notas adicionales o información relevante sobre el ascensor..."></textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <!-- Botones -->
                            <div
                                class="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 pt-6 border-t-2 border-gray-100">
                                <button type="submit" :disabled="form.processing"
                                    ...
                                    <span class="relative z-10">{{ form.processing ? 'Guardando...' : 'Guardar Cambios'
                                    }}</span>
                                </button>

                                <Link :href="route('elevators.index')"
                                    class="inline-flex items-center justify-center gap-2 px-6 py-4 bg-gray-100 hover:bg-gray-200 text-gray-700 font-semibold text-sm rounded-xl transition-all">
