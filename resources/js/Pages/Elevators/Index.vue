...
const onDeleted = () => {
  // Recarga solo la lista de ascensores, preservando scroll y estado
              ...
              <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="Ej: UNSL - Rectorado - Ascensor 1"
                    required
                  />
                ...
                <div class="grid grid-cols-1 w-full md:grid-cols-[1fr_116px] justify-end gap-3">
                  ...
                  <div class="hidden lg:flex items-center justify-end gap-2">
                    ...
                    <select
                      class="text-sm border-gray-300 rounded-md focus:border-indigo-500 focus:ring-indigo-200"
              ...
              >
                <div class="flex flex-col lg:flex-row lg:justify-between lg:items-start gap-4">
                  ...
                  <div class="flex flex-col sm:flex-row lg:flex-col gap-3 lg:min-w-[220px]">
                    ...
                    >
                      <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.03v13m0-13c-2.819-.831-4.715-1.076-8.029-1.023A.99.99 0 0 0 3 6v11c0 .563.466 1.014 1.03 1.007 3.122-.043 5.018.212 7.97 1.023m0-13c2.819-.831 4.715-1.076 8.029-1.023A.99.99 0 0 1 21 6v11c0 .563-.466 1.014-1.03 1.007-3.122-.043 5.018.212-7.97 1.023"/></svg>
                      Ver Revisiones
                    </a>
                    ...
                    <button
                      type="button"
                      class="inline-flex gap-3 items-center cursor-pointer justify-center px-5 py-3 bg-red-600 rounded-lg font-bold text-sm text-white uppercase tracking-wide hover:bg-red-700 transition-colors shadow-md"
                      @click="openDelete(elevator)"
                      :disabled="false /* !navigator.onLine */"
                    >
 ...
 Eliminar
            ...
            <div v-if="elevators?.links" class="mt-8 flex flex-wrap items-center justify-center gap-2">
              <template v-for="(link, i) in elevators.links" :key="i">
                <span
                  v-if="!link.url"
                  class="px-4 py-2 text-base text-gray-400 cursor-not-allowed"
                  v-html="translatePaginationLabel(link.label)"
                />
                <Link
                  v-else
                  :href="link.url"
                  class="px-4 py-2 text-base rounded-lg border transition-all"
                  :class="link.active
