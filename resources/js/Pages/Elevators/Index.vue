            ...
            <form @submit.prevent="submit" class="space-y-6">
              <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="space-y-2 animate-fade-in" style="animation-delay: 0.1s;">
                  ...
                  <transition enter-active-class="transition ease-out duration-200"
                    ...
                    <div v-if="form.errors.address"
                      ...
                      <span class="text-red-700 text-sm font-medium">{{ form.errors.address }}</span>
                    </div>
                  </transition>
                </div>
                ...
                <div class="space-y-2 animate-fade-in" style="animation-delay: 0.2s;">
                  <label class="flex items-center gap-2 text-sm font-semibold text-gray-700">
                    <svg class="w-4 h-4 text-purple-600" xmlns="http://www.w3.org/2000/svg" fill="none"
                      viewBox="0 0 24 24" stroke="currentColor">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                  ...
                  <div class="relative group">
                    ...
                    <div class="relative">
                      ...
                      <div class="absolute inset-y-0 right-0 pr-4 flex items-center gap-2">
                        ...
                        <div v-if="form.max_capacity_kg" class="text-green-500">
                          <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                          </svg>
                  ...
                  <transition enter-active-class="transition ease-out duration-200"
                    ...
                    leave-active-class="transition ease-in duration-150"
                    leave-from-class="opacity-100 transform scale-100" leave-to-class="opacity-0 transform scale-95">
                    <div v-if="form.errors.max_capacity_kg"
                      class="flex items-center gap-2 p-3 bg-red-50 border-l-4 border-red-500 rounded-lg">
                      <svg class="w-5 h-5 text-red-500 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                      ...
                      <span class="text-red-700 text-sm font-medium">{{ form.errors.max_capacity_kg }}</span>
                    </div>
                  </transition>
                </div>
              ...
              <div class="space-y-2 animate-fade-in" style="animation-delay: 0.3s;">
                ...
                <div class="relative group">
                  ...
                  <div class="relative">
                    ...
                    <div v-if="form.comments" class="absolute bottom-3 right-3 text-green-500">
                      <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                      </svg>
                ...
                <transition enter-active-class="transition ease-out duration-200"
                  ...
                  <div v-if="form.errors.comments"
                    ...
                    <span class="text-red-700 text-sm font-medium">{{ form.errors.comments }}</span>
                  </div>
                </transition>
              </div>
              ...
              <div v-for="(elevator, index) in elevators.data" :key="elevator.id"
                ...
                <div class="relative flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                  ...
                  <div class="flex flex-col sm:flex-row lg:flex-col gap-3 lg:min-w-[220px]">
                    ...
                    <Link :href="route('elevators.edit', elevator.id)"
